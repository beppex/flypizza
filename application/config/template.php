...
// public template
$template['public']['template'] = 'template_public';
...
// dialog template
$template['dialog']['template'] = 'template_dialog';
$template['dialog']['regions'] = array(
  'content'
);
$template['dialog']['parser'] = 'parser';
$template['dialog']['parser_method'] = 'parse';
$template['dialog']['parse_template'] = FALSE;


// template per la sezione amministrativa
